...
//        }
        ...
        /* 5. feladat */
        modell = new String[PinBevitel.DB+1];
    ...
    private void frissitModellt(){
        String temp = modell[PinBevitel.DB];
        modell[PinBevitel.DB] = modell[PinBevitel.DB - 1];
        modell[PinBevitel.DB - 1] = temp;
    }
...
//        }
        ...
        for (int i = 0; i < PinBevitel.DB-1; i++) {
            pnlBevitel.add(gombok[i]);
            gombok[i].setText(modell[i]);
        }
        String s = modell[PinBevitel.DB-1];
        if(kozepre){
    ...
    private void initComponents() {
        ...
        chbKozepre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chbKozepreActionPerformed(evt);
            }
        });
    ...
    private void chbKozepreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chbKozepreActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chbKozepreActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PinBevitel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PinBevitel().setVisible(true);
            }
        });
    }
